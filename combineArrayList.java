...
This method should create a new ArrayList of Integer, add all the numbers (in order) from numbersOne, then add all the numbers 
(in order) from numbersTwo. In other words, it is combining all the elements from the two lists.*/
...
for(int i=0; i < numbersOne.size(); i++) {
      list3.add(numbersOne.get(i));
    }
    for(int i=0; i < numbersTwo.size(); i++) {
      list3.add(numbersTwo.get(i));
    }
return list3;
}
